    ...
    <footer className="border-t border-line bg-shadow py-10 text-xs text-rock-dim">
      <div className="mx-auto flex max-w-5xl flex-col gap-4 px-6">
        <p className="max-w-[68ch] text-sm text-rock">
          Treeline covers marked, inbounds runs at lift-served resorts. It is not a
          backcountry planning tool.
        </p>
        <p className="max-w-[68ch]">
          Terrain data is approximate, derived from 30m elevation models. Not for
          navigation or safety decisions. Check{" "}
          <a
        ...
        <p className="max-w-[68ch]">
          Elevation from{" "}
          <a className="hover:text-rock" href="https://registry.opendata.aws/terrain-tiles/" rel="noreferrer noopener" target="_blank">
            AWS Terrain Tiles
          </a>
          . Imagery from Esri World Imagery. Runs and resort boundaries from{" "}
          <a className="hover:text-rock" href="https://www.openstreetmap.org/copyright" rel="noreferrer noopener" target="_blank">
            OpenStreetMap
          </a>{" "}
          contributors, ODbL. Weather from{" "}
          <a className="hover:text-rock" href="https://open-meteo.com" rel="noreferrer noopener" target="_blank">
            Open-Meteo
          </a>
          .
        </p>
